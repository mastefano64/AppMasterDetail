...
@Component({
  selector: 'app-formmastercreate',
  templateUrl: './form-master-create.component.html',
  styleUrls: ['./form-master-create.component.css']
})
export class FormMasterCreateComponent implements OnInit {
  @Output() confirm = new EventEmitter<MasterDto>();
  form = new MasterDto();

  constructor(private dialogRef: MatDialogRef<FormMasterCreateComponent>,
